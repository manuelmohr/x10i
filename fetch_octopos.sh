...
MD5SUMS="""7ca31ba9d02d072dd963cdd03584a36d  release.leon.${DEFAULT_LEON}.${RELEASE_DATE}.tar.bz2
bd762ebafbdb20addaf6bc83da2216cf  release.x86guest.${DEFAULT_X86GUEST}.${RELEASE_DATE}.tar.bz2"""
