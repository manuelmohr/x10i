...
MD5SUMS="""9a45b16b861cdf2880abe83c003c48b4  release.leon.${DEFAULT_LEON}.${RELEASE_DATE}.tar.bz2
9a44ff63692d5fa6fd597cd4b74ef14c  release.x86guest.${DEFAULT_X86GUEST}.${RELEASE_DATE}.tar.bz2"""
