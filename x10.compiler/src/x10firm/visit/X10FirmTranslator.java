...
/**
 * We need a Translator to hook into the Polyglot/X10 framework, but
 * we do not generate files directly. Therefore, we must ensure that
 * no actual code from Translator is called.
 * @author zwinkau
 *
 */
