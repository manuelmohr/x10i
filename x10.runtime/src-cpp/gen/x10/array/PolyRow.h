...
class PolyRow : public x10::array::ValRow   {
    ...
    void _constructor(x10aux::ref<x10::lang::ValRail<x10_int > > as_);
    
    static x10aux::ref<x10::array::PolyRow> _make(x10aux::ref<x10::lang::ValRail<x10_int > > as_);
    
    void _constructor(x10aux::ref<x10::lang::ValRail<x10_int > > as_, x10_int n);
...
template<class __T> x10aux::ref<__T> x10::array::PolyRow::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::array::PolyRow> this_ = new (x10aux::alloc_remote<x10::array::PolyRow>()) x10::array::PolyRow();
