#ifndef __X10_ARRAY_FULLREGION_H
#define __X10_ARRAY_FULLREGION_H
...
class FullRegion : public x10::array::Region   {
    public:
    RTT_H_DECLS_CLASS
    ...
    static x10::lang::Iterable<x10aux::ref<x10::array::Point> >::itable<x10::array::FullRegion > _itable_0;
    
    static x10::lang::Any::itable<x10::array::FullRegion > _itable_1;
    
    void _instance_init();
    
    void _constructor(x10_int rank);
    
    static x10aux::ref<x10::array::FullRegion> _make(x10_int rank);
    ...
    public: static void _serialize(x10aux::ref<x10::array::FullRegion> this_,
...
#endif // X10_ARRAY_FULLREGION_H

namespace x10 { namespace array { 
class FullRegion;
} } 

#ifndef X10_ARRAY_FULLREGION_H_NODEPS
#define X10_ARRAY_FULLREGION_H_NODEPS
#include <x10/array/Region.h>
...
#include <x10/lang/Iterator.h>
#include <x10/lang/Iterator.h>
#ifndef X10_ARRAY_FULLREGION_H_GENERICS
#define X10_ARRAY_FULLREGION_H_GENERICS
template<class __T> x10aux::ref<__T> x10::array::FullRegion::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::array::FullRegion> this_ = new (x10aux::alloc_remote<x10::array::FullRegion>()) x10::array::FullRegion();
    buf.record_reference(this_);
    this_->_deserialize_body(buf);
    return this_;
}

template<class __T> x10aux::ref<__T> x10::array::FullRegion::_deserialize(x10aux::deserialization_buffer& buf) {
    x10::lang::Object::_reference_state rr = x10::lang::Object::_deserialize_reference_state(buf);
    x10aux::ref<x10::array::FullRegion> this_;
    if (rr.ref != 0) {
        this_ = x10::array::FullRegion::_deserializer<x10::array::FullRegion>(buf);
    }
    return x10::lang::Object::_finalize_reference<__T>(this_, rr, buf);
}

#endif // X10_ARRAY_FULLREGION_H_GENERICS
#endif // __X10_ARRAY_FULLREGION_H_NODEPS
