...
class Console : public x10::lang::Object   {
    ...
    static x10aux::ref<x10::lang::Object> FMGL(OUT__deserialize)(x10aux::deserialization_buffer &buf);
    ...
    static x10aux::ref<x10::lang::Object> FMGL(ERR__deserialize)(x10aux::deserialization_buffer &buf);
    ...
    static x10aux::ref<x10::lang::Object> FMGL(IN__deserialize)(x10aux::deserialization_buffer &buf);
...
template<class __T> x10aux::ref<__T> x10::io::Console::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::io::Console> this_ = new (x10aux::alloc_remote<x10::io::Console>()) x10::io::Console();
