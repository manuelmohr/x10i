...
class ArrayIndexOutOfBoundsException : public x10::lang::RuntimeException
  {
    public:
    RTT_H_DECLS_CLASS
    ...
    static x10aux::ref<x10::lang::ArrayIndexOutOfBoundsException> _make();
    
    void _constructor(x10aux::ref<x10::lang::String> message);
    
    static x10aux::ref<x10::lang::ArrayIndexOutOfBoundsException> _make(x10aux::ref<x10::lang::String> message);
...
template<class __T> x10aux::ref<__T> x10::lang::ArrayIndexOutOfBoundsException::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::lang::ArrayIndexOutOfBoundsException> this_ = new (x10aux::alloc_remote<x10::lang::ArrayIndexOutOfBoundsException>()) x10::lang::ArrayIndexOutOfBoundsException();
