...
template<class __T> x10aux::ref<__T> x10::lang::UnsupportedOperationException::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::lang::UnsupportedOperationException> this_ = new (x10aux::alloc_remote<x10::lang::UnsupportedOperationException>()) x10::lang::UnsupportedOperationException();
