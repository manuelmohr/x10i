...
class BadPlaceException : public x10::lang::RuntimeException   {
    public:
    RTT_H_DECLS_CLASS
    ...
    static x10aux::ref<x10::lang::BadPlaceException> _make();
    
    void _constructor(x10aux::ref<x10::lang::String> message);
    
    static x10aux::ref<x10::lang::BadPlaceException> _make(x10aux::ref<x10::lang::String> message);
...
template<class __T> x10aux::ref<__T> x10::lang::BadPlaceException::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::lang::BadPlaceException> this_ = new (x10aux::alloc_remote<x10::lang::BadPlaceException>()) x10::lang::BadPlaceException();
