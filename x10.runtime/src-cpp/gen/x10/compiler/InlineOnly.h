#ifndef __X10_COMPILER_INLINEONLY_H
#define __X10_COMPILER_INLINEONLY_H
...
#define X10_COMPILER_INLINE_H_NODEPS
#include <x10/compiler/Inline.h>
#undef X10_COMPILER_INLINE_H_NODEPS
...
class InlineOnly   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::InlineOnly> this_,
...
#endif // X10_COMPILER_INLINEONLY_H

namespace x10 { namespace compiler { 
class InlineOnly;
} } 

#ifndef X10_COMPILER_INLINEONLY_H_NODEPS
#define X10_COMPILER_INLINEONLY_H_NODEPS
#include <x10/lang/Any.h>
#include <x10/compiler/Inline.h>
#ifndef X10_COMPILER_INLINEONLY_H_GENERICS
#define X10_COMPILER_INLINEONLY_H_GENERICS
#endif // X10_COMPILER_INLINEONLY_H_GENERICS
#endif // __X10_COMPILER_INLINEONLY_H_NODEPS
