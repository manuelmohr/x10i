#ifndef __X10_COMPILER_NORETURN_H
#define __X10_COMPILER_NORETURN_H
...
class NoReturn   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::NoReturn> this_,
...
#endif // X10_COMPILER_NORETURN_H

namespace x10 { namespace compiler { 
class NoReturn;
} } 

#ifndef X10_COMPILER_NORETURN_H_NODEPS
#define X10_COMPILER_NORETURN_H_NODEPS
#include <x10/lang/Any.h>
#include <x10/lang/annotations/MethodAnnotation.h>
#ifndef X10_COMPILER_NORETURN_H_GENERICS
#define X10_COMPILER_NORETURN_H_GENERICS
#endif // X10_COMPILER_NORETURN_H_GENERICS
#endif // __X10_COMPILER_NORETURN_H_NODEPS
