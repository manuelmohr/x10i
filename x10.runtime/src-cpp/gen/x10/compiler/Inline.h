#ifndef __X10_COMPILER_INLINE_H
#define __X10_COMPILER_INLINE_H
...
class Inline   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::Inline> this_,
...
#endif // X10_COMPILER_INLINE_H

namespace x10 { namespace compiler { 
class Inline;
} } 

#ifndef X10_COMPILER_INLINE_H_NODEPS
#define X10_COMPILER_INLINE_H_NODEPS
#include <x10/lang/Any.h>
#include <x10/lang/annotations/MethodAnnotation.h>
#include <x10/lang/annotations/ExpressionAnnotation.h>
#ifndef X10_COMPILER_INLINE_H_GENERICS
#define X10_COMPILER_INLINE_H_GENERICS
#endif // X10_COMPILER_INLINE_H_GENERICS
#endif // __X10_COMPILER_INLINE_H_NODEPS
