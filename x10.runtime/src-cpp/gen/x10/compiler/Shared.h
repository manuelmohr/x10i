...
template<class FMGL(T)> template<class __T> x10aux::ref<__T> x10::compiler::Shared<FMGL(T)>::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::compiler::Shared<FMGL(T)> > this_ = new (x10aux::alloc_remote<x10::compiler::Shared<FMGL(T)> >()) x10::compiler::Shared<FMGL(T)>();
...
#include "x10/compiler/Shared.inc"
...
//#line 15 "/home/tux/workspace/x10.runtime/src-x10/x10/compiler/Shared.x10": x10.ast.X10FieldDecl_c

//#line 16 "/home/tux/workspace/x10.runtime/src-x10/x10/compiler/Shared.x10": x10.ast.X10ConstructorDecl_c
template<class FMGL(T)> void x10::compiler::Shared<FMGL(T)>::_constructor(
                          FMGL(T) x) {
    this->x10::lang::Object::_constructor();
    
    //#line 16 "/home/tux/workspace/x10.runtime/src-x10/x10/compiler/Shared.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::compiler::Shared<FMGL(T)> >)this))->
      FMGL(x) = x;
...
//#line 17 "/home/tux/workspace/x10.runtime/src-x10/x10/compiler/Shared.x10": x10.ast.X10MethodDecl_c
template<class FMGL(T)> FMGL(T) x10::compiler::Shared<FMGL(T)>::get(
  ) {
    
    //#line 17 "/home/tux/workspace/x10.runtime/src-x10/x10/compiler/Shared.x10": x10.ast.X10Return_c
    return ((x10aux::ref<x10::compiler::Shared<FMGL(T)> >)this)->
             FMGL(x);
    
}

//#line 18 "/home/tux/workspace/x10.runtime/src-x10/x10/compiler/Shared.x10": x10.ast.X10MethodDecl_c
template<class FMGL(T)> void x10::compiler::Shared<FMGL(T)>::set(
  FMGL(T) x) {
    
    //#line 18 "/home/tux/workspace/x10.runtime/src-x10/x10/compiler/Shared.x10": polyglot.ast.Eval_c
...
template<class FMGL(T)> const x10aux::serialization_id_t x10::compiler::Shared<FMGL(T)>::_serialization_id = 
    x10aux::DeserializationDispatcher::addDeserializer(x10::compiler::Shared<FMGL(T)>::template _deserializer<x10::lang::Object>);
