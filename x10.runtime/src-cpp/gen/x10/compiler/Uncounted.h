#ifndef __X10_COMPILER_UNCOUNTED_H
#define __X10_COMPILER_UNCOUNTED_H
...
class Uncounted   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::Uncounted> this_,
...
#endif // X10_COMPILER_UNCOUNTED_H

namespace x10 { namespace compiler { 
class Uncounted;
} } 

#ifndef X10_COMPILER_UNCOUNTED_H_NODEPS
#define X10_COMPILER_UNCOUNTED_H_NODEPS
#include <x10/lang/Any.h>
#include <x10/lang/annotations/StatementAnnotation.h>
#ifndef X10_COMPILER_UNCOUNTED_H_GENERICS
#define X10_COMPILER_UNCOUNTED_H_GENERICS
#endif // X10_COMPILER_UNCOUNTED_H_GENERICS
#endif // __X10_COMPILER_UNCOUNTED_H_NODEPS
