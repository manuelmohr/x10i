#ifndef __X10_COMPILER_BYREF_H
#define __X10_COMPILER_BYREF_H
...
class ByRef   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::ByRef> this_,
...
#endif // X10_COMPILER_BYREF_H

namespace x10 { namespace compiler { 
class ByRef;
} } 

#ifndef X10_COMPILER_BYREF_H_NODEPS
#define X10_COMPILER_BYREF_H_NODEPS
#include <x10/lang/Any.h>
#include <x10/lang/annotations/ClassAnnotation.h>
#ifndef X10_COMPILER_BYREF_H_GENERICS
#define X10_COMPILER_BYREF_H_GENERICS
#endif // X10_COMPILER_BYREF_H_GENERICS
#endif // __X10_COMPILER_BYREF_H_NODEPS
