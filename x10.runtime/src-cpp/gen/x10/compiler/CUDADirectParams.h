#ifndef __X10_COMPILER_CUDADIRECTPARAMS_H
#define __X10_COMPILER_CUDADIRECTPARAMS_H
...
class CUDADirectParams   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::CUDADirectParams> this_,
...
#endif // X10_COMPILER_CUDADIRECTPARAMS_H

namespace x10 { namespace compiler { 
class CUDADirectParams;
} } 

#ifndef X10_COMPILER_CUDADIRECTPARAMS_H_NODEPS
#define X10_COMPILER_CUDADIRECTPARAMS_H_NODEPS
#include <x10/lang/Any.h>
#ifndef X10_COMPILER_CUDADIRECTPARAMS_H_GENERICS
#define X10_COMPILER_CUDADIRECTPARAMS_H_GENERICS
#endif // X10_COMPILER_CUDADIRECTPARAMS_H_GENERICS
#endif // __X10_COMPILER_CUDADIRECTPARAMS_H_NODEPS
