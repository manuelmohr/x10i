#ifndef __X10_COMPILER_HEADER_H
#define __X10_COMPILER_HEADER_H
...
class Header   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::Header> this_,
...
#endif // X10_COMPILER_HEADER_H

namespace x10 { namespace compiler { 
class Header;
} } 

#ifndef X10_COMPILER_HEADER_H_NODEPS
#define X10_COMPILER_HEADER_H_NODEPS
#include <x10/lang/Any.h>
#include <x10/lang/annotations/MethodAnnotation.h>
#ifndef X10_COMPILER_HEADER_H_GENERICS
#define X10_COMPILER_HEADER_H_GENERICS
#endif // X10_COMPILER_HEADER_H_GENERICS
#endif // __X10_COMPILER_HEADER_H_NODEPS
