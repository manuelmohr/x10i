#ifndef __X10_COMPILER_TRANSIENT_H
#define __X10_COMPILER_TRANSIENT_H
...
class Transient   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::Transient> this_,
...
#endif // X10_COMPILER_TRANSIENT_H

namespace x10 { namespace compiler { 
class Transient;
} } 

#ifndef X10_COMPILER_TRANSIENT_H_NODEPS
#define X10_COMPILER_TRANSIENT_H_NODEPS
#include <x10/lang/Any.h>
#include <x10/lang/annotations/StatementAnnotation.h>
#ifndef X10_COMPILER_TRANSIENT_H_GENERICS
#define X10_COMPILER_TRANSIENT_H_GENERICS
#endif // X10_COMPILER_TRANSIENT_H_GENERICS
#endif // __X10_COMPILER_TRANSIENT_H_NODEPS
