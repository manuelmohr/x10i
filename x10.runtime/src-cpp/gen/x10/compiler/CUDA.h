#ifndef __X10_COMPILER_CUDA_H
#define __X10_COMPILER_CUDA_H
...
class CUDA   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::CUDA> this_,
...
#endif // X10_COMPILER_CUDA_H

namespace x10 { namespace compiler { 
class CUDA;
} } 

#ifndef X10_COMPILER_CUDA_H_NODEPS
#define X10_COMPILER_CUDA_H_NODEPS
#include <x10/lang/Any.h>
#ifndef X10_COMPILER_CUDA_H_GENERICS
#define X10_COMPILER_CUDA_H_GENERICS
#endif // X10_COMPILER_CUDA_H_GENERICS
#endif // __X10_COMPILER_CUDA_H_NODEPS
