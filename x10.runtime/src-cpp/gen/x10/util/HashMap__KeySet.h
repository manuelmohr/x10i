...
template<class FMGL(Key), class FMGL(Value)> class x10_util_HashMap__KeySet__closure__0 : public x10::lang::Closure {
    ...
    // closure body
    FMGL(Key) apply(x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> > e) {
        
        //#line 262 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
    ...
    template<class __T> static x10aux::ref<__T> _deserialize(x10aux::deserialization_buffer &buf) {
        x10aux::ref<x10_util_HashMap__KeySet__closure__0<FMGL(Key),FMGL(Value) > > this_ = new (x10aux::alloc<x10_util_HashMap__KeySet__closure__0<FMGL(Key),FMGL(Value) > >()) x10_util_HashMap__KeySet__closure__0<FMGL(Key),FMGL(Value) >();
...
const x10aux::serialization_id_t x10_util_HashMap__KeySet__closure__0<FMGL(Key),FMGL(Value) >::_serialization_id = 
    x10aux::DeserializationDispatcher::addDeserializer(x10_util_HashMap__KeySet__closure__0<FMGL(Key),FMGL(Value) >::template _deserialize<x10::lang::Object>);
...
template<class FMGL(Key), class FMGL(Value)> template<class __T> x10aux::ref<__T> x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)>::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)> > this_ = new (x10aux::alloc_remote<x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)> >()) x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)>();
...
//#line 257 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10FieldDecl_c

//#line 259 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10ConstructorDecl_c
                                               ...
                                               x10aux::ref<x10::util::HashMap<FMGL(Key), FMGL(Value)> > map)
{
    ...
    //#line 259 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)> >)this))->
      FMGL(map) =
      map;
...
//#line 261 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
...
//#line 265 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10_boolean
  x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)>::contains(
  FMGL(Key) k) {
    
    //#line 266 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
...
//#line 269 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10_boolean
  x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)>::add(
  FMGL(Key) k) {
    
    //#line 269 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Throw_c
    x10aux::throwException(x10aux::nullCheck(x10::lang::UnsupportedOperationException::_make()));
}

//#line 270 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10_boolean
  x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)>::remove(
  FMGL(Key) k) {
    
    //#line 270 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Throw_c
    x10aux::throwException(x10aux::nullCheck(x10::lang::UnsupportedOperationException::_make()));
}

//#line 271 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10aux::ref<x10::util::Container<FMGL(Key)> >
  x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)>::clone(
  ) {
    
    //#line 271 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Throw_c
    x10aux::throwException(x10aux::nullCheck(x10::lang::UnsupportedOperationException::_make()));
}

//#line 272 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10_int
  x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)>::size(
  ) {
    
    //#line 272 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
    return x10aux::nullCheck(((x10aux::ref<x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)> >)this)->
                               FMGL(map))->size();
...
const x10aux::serialization_id_t x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)>::_serialization_id = 
    x10aux::DeserializationDispatcher::addDeserializer(x10::util::HashMap__KeySet<FMGL(Key), FMGL(Value)>::template _deserializer<x10::lang::Object>);
