...
template<class FMGL(Key), class FMGL(Value)> template<class __T> x10aux::ref<__T> x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> > this_ = new (x10aux::alloc_remote<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >()) x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>();
...
#include "x10/util/HashMap__HashEntry.inc"

template<class FMGL(Key), class FMGL(Value)> typename x10::util::Map__Entry<FMGL(Key), FMGL(Value)>::template itable<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >  x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::_itable_0(&x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::at, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::at, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::equals, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::getKey, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::getValue, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::hashCode, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::home, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::setValue, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::toString, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::typeName);
template<class FMGL(Key), class FMGL(Value)> x10::lang::Any::itable<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >  x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::_itable_1(&x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::at, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::at, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::equals, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::hashCode, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::home, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::toString, &x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::typeName);
...
//#line 16 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)> FMGL(Key) x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::getKey(
  ) {
    
    //#line 16 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
    return ((x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >)this)->
             FMGL(key);
    
}

//#line 17 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)> FMGL(Value) x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::getValue(
  ) {
    
    //#line 17 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
    return ((x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >)this)->
             FMGL(value);
    
}

//#line 18 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
void
  x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::setValue(
  FMGL(Value) v) {
    
    //#line 18 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    ((x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >)this)->
      FMGL(value) = v;
}

//#line 20 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10FieldDecl_c

//#line 21 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10FieldDecl_c

//#line 22 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10FieldDecl_c

//#line 23 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10FieldDecl_c

//#line 25 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10ConstructorDecl_c
template<class FMGL(Key), class FMGL(Value)>
  ...
  x10_int h)
{
    ...
    //#line 22 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >)this))->
      FMGL(removed) =
      false;
    
    //#line 26 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >)this))->
      FMGL(key) =
      key;
    
    //#line 27 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >)this))->
      FMGL(value) =
      value;
    
    //#line 28 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >)this))->
      FMGL(hash) =
      h;
    
    //#line 29 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >)this))->
      FMGL(removed) =
      false;
...
const x10aux::serialization_id_t x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::_serialization_id = 
    x10aux::DeserializationDispatcher::addDeserializer(x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)>::template _deserializer<x10::lang::Object>);
