...
template<class FMGL(T)> template<class __T> x10aux::ref<__T> x10::util::RailBuilder<FMGL(T)>::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::util::RailBuilder<FMGL(T)> > this_ = new (x10aux::alloc_remote<x10::util::RailBuilder<FMGL(T)> >()) x10::util::RailBuilder<FMGL(T)>();
...
#include "x10/util/RailBuilder.inc"

template<class FMGL(T)> typename x10::util::Builder<FMGL(T), x10aux::ref<x10::lang::Rail<FMGL(T) > > >::template itable<x10::util::RailBuilder<FMGL(T)> >  x10::util::RailBuilder<FMGL(T)>::_itable_0(&x10::util::RailBuilder<FMGL(T)>::add, &x10::util::RailBuilder<FMGL(T)>::at, &x10::util::RailBuilder<FMGL(T)>::at, &x10::util::RailBuilder<FMGL(T)>::equals, &x10::util::RailBuilder<FMGL(T)>::hashCode, &x10::util::RailBuilder<FMGL(T)>::home, &x10::util::RailBuilder<FMGL(T)>::result, &x10::util::RailBuilder<FMGL(T)>::toString, &x10::util::RailBuilder<FMGL(T)>::typeName);
template<class FMGL(T)> x10::lang::Any::itable<x10::util::RailBuilder<FMGL(T)> >  x10::util::RailBuilder<FMGL(T)>::_itable_1(&x10::util::RailBuilder<FMGL(T)>::at, &x10::util::RailBuilder<FMGL(T)>::at, &x10::util::RailBuilder<FMGL(T)>::equals, &x10::util::RailBuilder<FMGL(T)>::hashCode, &x10::util::RailBuilder<FMGL(T)>::home, &x10::util::RailBuilder<FMGL(T)>::toString, &x10::util::RailBuilder<FMGL(T)>::typeName);
...
//#line 15 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": x10.ast.X10FieldDecl_c

//#line 17 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": x10.ast.X10ConstructorDecl_c
template<class FMGL(T)> void x10::util::RailBuilder<FMGL(T)>::_constructor(
                          ) {
    this->x10::lang::Object::_constructor();
    
    //#line 18 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::util::RailBuilder<FMGL(T)> >)this))->
      FMGL(buf) = x10::util::GrowableRail<FMGL(T) >::_make();
...
//#line 21 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": x10.ast.X10ConstructorDecl_c
template<class FMGL(T)> void x10::util::RailBuilder<FMGL(T)>::_constructor(
                          x10_int size) {
    this->x10::lang::Object::_constructor();
    
    //#line 22 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::util::RailBuilder<FMGL(T)> >)this))->
      FMGL(buf) = x10::util::GrowableRail<FMGL(T) >::_make(size);
...
//#line 25 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": x10.ast.X10MethodDecl_c
template<class FMGL(T)> x10aux::ref<x10::util::Builder<FMGL(T), x10aux::ref<x10::lang::Rail<FMGL(T) > > > >
  x10::util::RailBuilder<FMGL(T)>::add(
  FMGL(T) x) {
    
    //#line 26 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": polyglot.ast.Eval_c
    (((x10aux::ref<x10::util::RailBuilder<FMGL(T)> >)this)->
       FMGL(buf))->add(x);
    
    //#line 27 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": x10.ast.X10Return_c
    return ((x10aux::ref<x10::util::RailBuilder<FMGL(T)> >)this);
    
}

//#line 30 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": x10.ast.X10MethodDecl_c
template<class FMGL(T)> x10_int x10::util::RailBuilder<FMGL(T)>::length(
  ) {
    
    //#line 31 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": x10.ast.X10Return_c
    return (((x10aux::ref<x10::util::RailBuilder<FMGL(T)> >)this)->
              FMGL(buf))->length();
    
}

//#line 34 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": x10.ast.X10MethodDecl_c
template<class FMGL(T)> x10aux::ref<x10::lang::Rail<FMGL(T) > >
  x10::util::RailBuilder<FMGL(T)>::result(
  ) {
    
    //#line 35 "/home/tux/workspace/x10.runtime/src-x10/x10/util/RailBuilder.x10": x10.ast.X10Return_c
    return (((x10aux::ref<x10::util::RailBuilder<FMGL(T)> >)this)->
              FMGL(buf))->toRail();
    
}
template<class FMGL(T)> const x10aux::serialization_id_t x10::util::RailBuilder<FMGL(T)>::_serialization_id = 
    x10aux::DeserializationDispatcher::addDeserializer(x10::util::RailBuilder<FMGL(T)>::template _deserializer<x10::lang::Object>);
