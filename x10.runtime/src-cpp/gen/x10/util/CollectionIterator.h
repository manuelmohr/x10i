...
template<class FMGL(T)> class CollectionIterator   {
    ...
    template <class I> struct itable {
        itable(x10_boolean (I::*_m0__at) (x10aux::ref<x10::lang::Object>), x10_boolean (I::*_m1__at) (x10::lang::Place), x10_boolean (I::*equals) (x10aux::ref<x10::lang::Any>), x10_boolean (I::*hasNext) (), x10_int (I::*hashCode) (), x10::lang::Place (I::*home) (), FMGL(T) (I::*next) (), void (I::*remove) (), x10aux::ref<x10::lang::String> (I::*toString) (), x10aux::ref<x10::lang::String> (I::*typeName) ()) : _m0__at(_m0__at), _m1__at(_m1__at), equals(equals), hasNext(hasNext), hashCode(hashCode), home(home), next(next), remove(remove), toString(toString), typeName(typeName) {}
    ...
    static void _serialize(x10aux::ref<x10::util::CollectionIterator<FMGL(T)> > this_,
...
#include "x10/util/CollectionIterator.inc"
