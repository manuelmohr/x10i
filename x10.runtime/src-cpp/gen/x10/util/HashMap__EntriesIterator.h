...
template<class FMGL(Key), class FMGL(Value)> template<class __T> x10aux::ref<__T> x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)>::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> > this_ = new (x10aux::alloc_remote<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> >()) x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)>();
...
//#line 222 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10FieldDecl_c

//#line 223 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10FieldDecl_c

//#line 224 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10FieldDecl_c

//#line 226 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10ConstructorDecl_c
template<class FMGL(Key), class FMGL(Value)> void x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)>::_constructor(
                                               x10aux::ref<x10::util::HashMap<FMGL(Key), FMGL(Value)> > map)
{
    this->x10::lang::Object::_constructor();
    
    //#line 223 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> >)this))->
      FMGL(i) =
      ((x10_int)0);
    
    //#line 224 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> >)this))->
      FMGL(originalModCount) =
      ((x10_int)0);
    
    //#line 226 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> >)this))->
      FMGL(map) =
      map;
...
//#line 228 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
void
  x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)>::advance(
  ) {
    
    //#line 229 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10While_c
                             ...
                             FMGL(length))))
    {
        ...
        //#line 230 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10If_c
        if ((!x10aux::struct_equals((x10aux::nullCheck(((x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> >)this)->
                                                         FMGL(map))->
                                       FMGL(table))->apply(((x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> >)this)->
                                                             FMGL(i)),
                                    x10aux::null)) &&
                 ...
                 FMGL(removed))))
        {
            ...
            //#line 231 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
            return;
        }
        
        //#line 232 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
        (__extension__ ({
...
//#line 236 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10_boolean
  x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)>::hasNext(
  ) {
    
    //#line 237 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10If_c
                          ...
                          FMGL(length))))
    {
        ...
        //#line 239 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
        return true;
        
    }
    
    //#line 241 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
    return false;
    
}

//#line 244 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10MethodDecl_c
template<class FMGL(Key), class FMGL(Value)>
x10aux::ref<x10::util::HashMap__HashEntry<FMGL(Key), FMGL(Value)> >
  x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)>::next(
  ) {
    
    //#line 245 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10If_c
                                  ...
                                  FMGL(modCount))))
    {
        ...
        //#line 245 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Throw_c
        x10aux::throwException(x10aux::nullCheck(x10::lang::RuntimeException::_make(((((x10::lang::String::Lit("Your code has a concurrency bug! You updated the hashmap ")) + (((x10_int) ((x10aux::nullCheck(((x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> >)this)->
                                                                                                                                                                                                                 FMGL(map))->
                                                                                                                                                                                               FMGL(modCount)) - (((x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> >)this)->
                                                                                                                                                                                                                    FMGL(originalModCount))))))) + (x10::lang::String::Lit(" times since you created the iterator."))))));
    }
    
    //#line 246 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10LocalDecl_c
    x10_int j = ((x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> >)this)->
                  FMGL(i);
    
    //#line 248 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    (__extension__ ({
        x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> > x =
          ((x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> >)this);
        x10_int y =
    ...
    //#line 249 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": polyglot.ast.Eval_c
    ((x10aux::ref<x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)> >)this)->advance();
    
    //#line 250 "/home/tux/workspace/x10.runtime/src-x10/x10/util/HashMap.x10": x10.ast.X10Return_c
...
const x10aux::serialization_id_t x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)>::_serialization_id = 
    x10aux::DeserializationDispatcher::addDeserializer(x10::util::HashMap__EntriesIterator<FMGL(Key), FMGL(Value)>::template _deserializer<x10::lang::Object>);
