...
extern "C" {
  ...
  /** \brief check whether a non-blocking collective is done yet 
   */

  unsigned             __pgasrt_tspcoll_isdone     (void             * arg);
  ...
  void *               __pgasrt_tspcoll_ibarrier    (int               commID);
  ...
  void *                __pgasrt_tspcoll_iallgather   (int               commID,
						     const void      * sbuf,
						     void            * dbuf,
						     size_t            nbytes);
  ...
  void*                __pgasrt_tspcoll_iallgatherv  (int               commID,
						     const void      * sbuf,
						     void            * dbuf,
						     size_t          * llengs);
  ...
  void *               __pgasrt_tspcoll_ibcast      (int              commID, 
						     int               root,
						     const void      * sbuf,
						     void            * dbuf,
						     size_t            nbytes);
  ...
  void *               __pgasrt_tspcoll_iallreduce  (int               commID,
                                                     const void      * sbuf,
                                                     void            * rbuf,
                                                     __pgasrt_ops_t    op,
                                                     __pgasrt_dtypes_t dtype,
  ...
  void                 __pgasrt_tspcoll_alltoall    (int               commID,
						     const void      * sbuf,
                                                     void            * rbuf,
						     size_t            len);

  void *               __pgasrt_tspcoll_ialltoall   (int               commID,
						     const void      * sbuf,
                                                     void            * rbuf,
						     size_t            len);

  void                 __pgasrt_tspcoll_alltoallv    (int               commID,
						     const void      ** sbuf,
                                                     const size_t     * src_len,
                                                     void            ** rbuf,
                                                     const size_t       * dst_len);

  void*                 __pgasrt_tspcoll_ialltoallv    (int               commID,
						     const void      ** sbuf,
                                                     const size_t       * src_len,
                                                     void            ** rbuf,
                                                     const size_t      * dst_len);
