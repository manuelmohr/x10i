...
/* **************************************************************************/
/** \brief Initialize a thread specific part of the communication system.   
 *  Reentrant. Each thread must call this function after the main thread 
 *  called _pgasrt_tsp_setup(...)
 */
/* **************************************************************************/
#if TRANSPORT == bgp

EXTERN void 
__pgasrt_tsp_thread_setup(void);
...
EXTERN void * 
__pgasrt_tsp_dupdate               (unsigned                     localThread,
				    unsigned                     destNode,
				    __pgasrt_local_addr_t        dst,
				    size_t                       offset,
				    __pgasrt_local_addr_t        src,
...
#define PGASRT_TSP_AMSEND_REG_MAX        10000

/* !!!TODO!!! There should be a better place for these defines */

#define PGASRT_TSP_AMSEND_COLLEXCHANGE    (PGASRT_TSP_AMSEND_REG_MAX-1)
#define PGASRT_TSP_AMSEND_COLLGATHER      (PGASRT_TSP_AMSEND_REG_MAX-2)
#define PGASRT_TSP_AMSEND_COLLSCATTER     (PGASRT_TSP_AMSEND_REG_MAX-3)
#define PGASRT_TSP_AMSEND_UPCRTALLOC1     (PGASRT_TSP_AMSEND_REG_MAX-4)
#define PGASRT_TSP_AMSEND_UPCRTALLOC2     (PGASRT_TSP_AMSEND_REG_MAX-5)
#define PGASRT_TSP_AMSEND_UPCRTLOCK1      (PGASRT_TSP_AMSEND_REG_MAX-6)
#define PGASRT_TSP_AMSEND_UPCRTLOCK2      (PGASRT_TSP_AMSEND_REG_MAX-7)
#define PGASRT_TSP_AMSEND_BARRIER         (PGASRT_TSP_AMSEND_REG_MAX-8)
#define PGASRT_TSP_AMSEND_COLLA2A         (PGASRT_TSP_AMSEND_REG_MAX-9)

#define PGASRT_TSP_AMSEND_X10ARRCPY       (PGASRT_TSP_AMSEND_REG_MAX-10)
#define PGASRT_TSP_AMSEND_X10FINALIZE     (PGASRT_TSP_AMSEND_REG_MAX-11)
#define PGASRT_TSP_AMSEND_X10INLASYNC     (PGASRT_TSP_AMSEND_REG_MAX-12)
#define PGASRT_TSP_AMSEND_X10QUEASYNC     (PGASRT_TSP_AMSEND_REG_MAX-13)
#define PGASRT_TSP_AMSEND_X10TAGASYNC     (PGASRT_TSP_AMSEND_REG_MAX-14)
#define PGASRT_TSP_AMSEND_X10BCAST        (PGASRT_TSP_AMSEND_REG_MAX-15)
#define PGASRT_TSP_AMSEND_X10FINISHBEG    (PGASRT_TSP_AMSEND_REG_MAX-16)
#define PGASRT_TSP_AMSEND_X10FINISHEND    (PGASRT_TSP_AMSEND_REG_MAX-17)
#define PGASRT_TSP_AMSEND_COLLA2AV         (PGASRT_TSP_AMSEND_REG_MAX-18)
...
EXTERN void
__pgasrt_tsp_amsend_reg            (__pgasrt_AMHeaderReg_t       id,
				    __pgasrt_AMHeaderHandler_t   hndlr);
/* **************************************************************************/
/* **************************************************************************/

EXTERN __pgasrt_AMHeaderHandler_t
__pgasrt_tsp_amsend_lookup         (__pgasrt_AMHeaderReg_t       hndlr);
