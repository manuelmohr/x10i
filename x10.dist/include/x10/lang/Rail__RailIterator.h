...
template<class FMGL(S)> template<class __T> x10aux::ref<__T> x10::lang::Rail__RailIterator<FMGL(S)>::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::lang::Rail__RailIterator<FMGL(S)> > this_ = new (x10aux::alloc_remote<x10::lang::Rail__RailIterator<FMGL(S)> >()) x10::lang::Rail__RailIterator<FMGL(S)>();
...
#include "x10/lang/Rail__RailIterator.inc"

template<class FMGL(S)> typename x10::lang::Iterator<FMGL(S)>::template itable<x10::lang::Rail__RailIterator<FMGL(S)> >  x10::lang::Rail__RailIterator<FMGL(S)>::_itable_0(&x10::lang::Rail__RailIterator<FMGL(S)>::at, &x10::lang::Rail__RailIterator<FMGL(S)>::at, &x10::lang::Rail__RailIterator<FMGL(S)>::equals, &x10::lang::Rail__RailIterator<FMGL(S)>::hasNext, &x10::lang::Rail__RailIterator<FMGL(S)>::hashCode, &x10::lang::Rail__RailIterator<FMGL(S)>::home, &x10::lang::Rail__RailIterator<FMGL(S)>::next, &x10::lang::Rail__RailIterator<FMGL(S)>::toString, &x10::lang::Rail__RailIterator<FMGL(S)>::typeName);
template<class FMGL(S)> x10::lang::Any::itable<x10::lang::Rail__RailIterator<FMGL(S)> >  x10::lang::Rail__RailIterator<FMGL(S)>::_itable_1(&x10::lang::Rail__RailIterator<FMGL(S)>::at, &x10::lang::Rail__RailIterator<FMGL(S)>::at, &x10::lang::Rail__RailIterator<FMGL(S)>::equals, &x10::lang::Rail__RailIterator<FMGL(S)>::hashCode, &x10::lang::Rail__RailIterator<FMGL(S)>::home, &x10::lang::Rail__RailIterator<FMGL(S)>::toString, &x10::lang::Rail__RailIterator<FMGL(S)>::typeName);
...
//#line 421 "/home/tux/workspace/x10.runtime/src-x10/x10/lang/Rail.x10": x10.ast.X10FieldDecl_c

//#line 422 "/home/tux/workspace/x10.runtime/src-x10/x10/lang/Rail.x10": x10.ast.X10FieldDecl_c

//#line 424 "/home/tux/workspace/x10.runtime/src-x10/x10/lang/Rail.x10": x10.ast.X10ConstructorDecl_c
template<class FMGL(S)> void x10::lang::Rail__RailIterator<FMGL(S)>::_constructor(
                          x10aux::ref<x10::lang::Rail<FMGL(S) > > r)
{
    this->x10::lang::Object::_constructor();
    
    //#line 421 "/home/tux/workspace/x10.runtime/src-x10/x10/lang/Rail.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::lang::Rail__RailIterator<FMGL(S)> >)this))->
      FMGL(curIndex) =
      ((x10_int)0);
    
    //#line 424 "/home/tux/workspace/x10.runtime/src-x10/x10/lang/Rail.x10": polyglot.ast.Eval_c
    x10aux::placeCheck(((x10aux::ref<x10::lang::Rail__RailIterator<FMGL(S)> >)this))->
      FMGL(rail) =
      r;
...
//#line 425 "/home/tux/workspace/x10.runtime/src-x10/x10/lang/Rail.x10": x10.ast.X10MethodDecl_c
template<class FMGL(S)> x10_boolean x10::lang::Rail__RailIterator<FMGL(S)>::hasNext(
  ) {
    
    //#line 425 "/home/tux/workspace/x10.runtime/src-x10/x10/lang/Rail.x10": x10.ast.X10Return_c
...
//#line 426 "/home/tux/workspace/x10.runtime/src-x10/x10/lang/Rail.x10": x10.ast.X10MethodDecl_c
template<class FMGL(S)> FMGL(S) x10::lang::Rail__RailIterator<FMGL(S)>::next(
  ) {
    
    //#line 426 "/home/tux/workspace/x10.runtime/src-x10/x10/lang/Rail.x10": x10.ast.X10Return_c
    return (((x10aux::ref<x10::lang::Rail__RailIterator<FMGL(S)> >)this)->
...
template<class FMGL(S)> const x10aux::serialization_id_t x10::lang::Rail__RailIterator<FMGL(S)>::_serialization_id = 
    x10aux::DeserializationDispatcher::addDeserializer(x10::lang::Rail__RailIterator<FMGL(S)>::template _deserializer<x10::lang::Object>);
