...
class Math : public x10::lang::Object   {
    ...
    public: static void _serialize(x10aux::ref<x10::lang::Math> this_,
...
template<class __T> x10aux::ref<__T> x10::lang::Math::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::lang::Math> this_ = new (x10aux::alloc_remote<x10::lang::Math>()) x10::lang::Math();
    buf.record_reference(this_);
    this_->_deserialize_body(buf);
    return this_;
}

template<class __T> x10aux::ref<__T> x10::lang::Math::_deserialize(x10aux::deserialization_buffer& buf) {
    x10::lang::Object::_reference_state rr = x10::lang::Object::_deserialize_reference_state(buf);
    x10aux::ref<x10::lang::Math> this_;
    if (rr.ref != 0) {
        this_ = x10::lang::Math::_deserializer<x10::lang::Math>(buf);
    }
