...
template<class FMGL(I), class FMGL(V)> class Indexable   {
    ...
    template <class I> struct itable {
        itable(FMGL(V) (I::*apply) (FMGL(I)), x10_boolean (I::*_m1__at) (x10aux::ref<x10::lang::Object>), x10_boolean (I::*_m2__at) (x10::lang::Place), x10_boolean (I::*equals) (x10aux::ref<x10::lang::Any>), x10_int (I::*hashCode) (), x10::lang::Place (I::*home) (), x10aux::ref<x10::lang::String> (I::*toString) (), x10aux::ref<x10::lang::String> (I::*typeName) ()) : apply(apply), _m1__at(_m1__at), _m2__at(_m2__at), equals(equals), hashCode(hashCode), home(home), toString(toString), typeName(typeName) {}
        FMGL(V) (I::*apply) (FMGL(I));
    ...
    static void _serialize(x10aux::ref<x10::lang::Indexable<FMGL(I), FMGL(V)> > this_,
...
#include "x10/lang/Indexable.inc"
