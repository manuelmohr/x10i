...
class StringBuilder : public x10::lang::Object   {
    ...
    x10aux::ref<x10::util::ValRailBuilder<x10_char> > FMGL(buf);
    ...
    virtual x10aux::ref<x10::util::StringBuilder> insert(
      x10_int p,
      x10_boolean x);
    virtual x10aux::ref<x10::util::StringBuilder> insert(
      x10_int p,
    ...
    virtual x10aux::ref<x10::util::StringBuilder> insert(
      x10_int p,
      x10aux::ref<x10::lang::String> x);
    virtual x10aux::ref<x10::util::StringBuilder> addString(
      x10aux::ref<x10::lang::String> s);
    virtual x10aux::ref<x10::util::StringBuilder> insertString(
      x10_int pos,
      x10aux::ref<x10::lang::String> s);
...
template<class __T> x10aux::ref<__T> x10::util::StringBuilder::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::util::StringBuilder> this_ = new (x10aux::alloc_remote<x10::util::StringBuilder>()) x10::util::StringBuilder();
