...
template<class FMGL(T)> class Indexed   {
    ...
    template <class I> struct itable {
        itable(FMGL(T) (I::*apply) (x10_int), x10_boolean (I::*_m1__at) (x10aux::ref<x10::lang::Object>), x10_boolean (I::*_m2__at) (x10::lang::Place), x10aux::ref<x10::util::Container<FMGL(T)> > (I::*clone) (), x10_boolean (I::*contains) (FMGL(T)), x10_boolean (I::*containsAll) (x10aux::ref<x10::util::Container<FMGL(T)> >), x10_boolean (I::*equals) (x10aux::ref<x10::lang::Any>), x10_int (I::*hashCode) (), x10::lang::Place (I::*home) (), x10_boolean (I::*isEmpty) (), x10aux::ref<x10::lang::Iterator<FMGL(T)> > (I::*iterator) (), x10_int (I::*size) (), x10aux::ref<x10::lang::Rail<FMGL(T) > > (I::*toRail) (), x10aux::ref<x10::lang::String> (I::*toString) (), x10aux::ref<x10::lang::ValRail<FMGL(T) > > (I::*toValRail) (), x10aux::ref<x10::lang::String> (I::*typeName) ()) : apply(apply), _m1__at(_m1__at), _m2__at(_m2__at), clone(clone), contains(contains), containsAll(containsAll), equals(equals), hashCode(hashCode), home(home), isEmpty(isEmpty), iterator(iterator), size(size), toRail(toRail), toString(toString), toValRail(toValRail), typeName(typeName) {}
    ...
    static void _serialize(x10aux::ref<x10::util::Indexed<FMGL(T)> > this_,
