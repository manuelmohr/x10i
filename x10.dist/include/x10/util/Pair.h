...
template<class FMGL(T), class FMGL(U)> class Pair_methods  {
    ...
    static void _constructor(x10::util::Pair<FMGL(T), FMGL(U)>& this_, FMGL(T) first,
        ...
        //#line 22 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": polyglot.ast.Eval_c
        this_->FMGL(first) = first;
        
        //#line 23 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": polyglot.ast.Eval_c
...
template<class FMGL(T), class FMGL(U)> x10::lang::Any::itable<Pair_ithunk0<FMGL(T), FMGL(U)> >  Pair_ithunk0<FMGL(T), FMGL(U)>::itable(&Pair_ithunk0<FMGL(T), FMGL(U)>::at, &Pair_ithunk0<FMGL(T), FMGL(U)>::at, &Pair_ithunk0<FMGL(T), FMGL(U)>::equals, &Pair_ithunk0<FMGL(T), FMGL(U)>::hashCode, &Pair_ithunk0<FMGL(T), FMGL(U)>::home, &Pair_ithunk0<FMGL(T), FMGL(U)>::toString, &Pair_ithunk0<FMGL(T), FMGL(U)>::typeName);
...
template<class FMGL(T), class FMGL(U)> x10::lang::Any::itable<Pair_iboxithunk0<FMGL(T), FMGL(U)> >  Pair_iboxithunk0<FMGL(T), FMGL(U)>::itable(&Pair_iboxithunk0<FMGL(T), FMGL(U)>::at, &Pair_iboxithunk0<FMGL(T), FMGL(U)>::at, &Pair_iboxithunk0<FMGL(T), FMGL(U)>::equals, &Pair_iboxithunk0<FMGL(T), FMGL(U)>::hashCode, &Pair_iboxithunk0<FMGL(T), FMGL(U)>::home, &Pair_iboxithunk0<FMGL(T), FMGL(U)>::toString, &Pair_iboxithunk0<FMGL(T), FMGL(U)>::typeName);
} } 
...
//#line 18 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": x10.ast.X10FieldDecl_c

//#line 19 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": x10.ast.X10FieldDecl_c

//#line 21 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": x10.ast.X10ConstructorDecl_c


//#line 26 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": x10.ast.X10MethodDecl_c
template<class FMGL(T), class FMGL(U)> x10aux::ref<x10::lang::String> x10::util::Pair_methods<FMGL(T), FMGL(U)>::toString(
  x10::util::Pair<FMGL(T), FMGL(U)> this_) {
    
    //#line 27 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": x10.ast.X10Return_c
    return ((((((((x10::lang::String::Lit("(")) + (this_->FMGL(first)))) + (x10::lang::String::Lit(", ")))) + (this_->
                                                                                                                 FMGL(second)))) + (x10::lang::String::Lit(")")));
    
}

//#line 17 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": x10.ast.X10MethodDecl_c
...
template<class FMGL(T), class FMGL(U)> x10_int x10::util::Pair_methods<FMGL(T), FMGL(U)>::hashCode(
  x10::util::Pair<FMGL(T), FMGL(U)> this_) {
    ...
    //#line 17 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": x10.ast.X10LocalDecl_c
    x10_int result = ((x10_int)0);
    
    //#line 17 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": polyglot.ast.Eval_c
    ...
    //#line 17 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": x10.ast.X10Return_c
    return result;
...
template<class FMGL(T), class FMGL(U)> x10_boolean
  ...
  x10::util::Pair<FMGL(T), FMGL(U)> this_, x10aux::ref<x10::lang::Any> other) {
    ...
    //#line 17 "/home/tux/workspace/x10.runtime/src-x10/x10/util/Pair.x10": x10.ast.X10If_c
