#ifndef __X10_COMPILER_NOINLINE_H
#define __X10_COMPILER_NOINLINE_H
...
class NoInline   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::NoInline> this_,
...
#endif // X10_COMPILER_NOINLINE_H

namespace x10 { namespace compiler { 
class NoInline;
} } 

#ifndef X10_COMPILER_NOINLINE_H_NODEPS
#define X10_COMPILER_NOINLINE_H_NODEPS
#include <x10/lang/Any.h>
#include <x10/lang/annotations/MethodAnnotation.h>
#include <x10/lang/annotations/ExpressionAnnotation.h>
#ifndef X10_COMPILER_NOINLINE_H_GENERICS
#define X10_COMPILER_NOINLINE_H_GENERICS
#endif // X10_COMPILER_NOINLINE_H_GENERICS
#endif // __X10_COMPILER_NOINLINE_H_NODEPS
