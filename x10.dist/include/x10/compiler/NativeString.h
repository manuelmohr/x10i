#ifndef __X10_COMPILER_NATIVESTRING_H
#define __X10_COMPILER_NATIVESTRING_H
...
class NativeString   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::NativeString> this_,
...
#endif // X10_COMPILER_NATIVESTRING_H

namespace x10 { namespace compiler { 
class NativeString;
} } 

#ifndef X10_COMPILER_NATIVESTRING_H_NODEPS
#define X10_COMPILER_NATIVESTRING_H_NODEPS
#include <x10/lang/Any.h>
#include <x10/lang/annotations/ExpressionAnnotation.h>
#ifndef X10_COMPILER_NATIVESTRING_H_GENERICS
#define X10_COMPILER_NATIVESTRING_H_GENERICS
#endif // X10_COMPILER_NATIVESTRING_H_GENERICS
#endif // __X10_COMPILER_NATIVESTRING_H_NODEPS
