#ifndef __X10_COMPILER_STACKALLOCATE_H
#define __X10_COMPILER_STACKALLOCATE_H
...
class StackAllocate   {
    ...
    static void _serialize(x10aux::ref<x10::compiler::StackAllocate> this_,
...
#endif // X10_COMPILER_STACKALLOCATE_H

namespace x10 { namespace compiler { 
class StackAllocate;
} } 

#ifndef X10_COMPILER_STACKALLOCATE_H_NODEPS
#define X10_COMPILER_STACKALLOCATE_H_NODEPS
#include <x10/lang/Any.h>
#include <x10/lang/annotations/ExpressionAnnotation.h>
#include <x10/lang/annotations/StatementAnnotation.h>
#ifndef X10_COMPILER_STACKALLOCATE_H_GENERICS
#define X10_COMPILER_STACKALLOCATE_H_GENERICS
#endif // X10_COMPILER_STACKALLOCATE_H_GENERICS
#endif // __X10_COMPILER_STACKALLOCATE_H_NODEPS
