...
template<class FMGL(T)> class Ref   {
    ...
    template <class I> struct itable {
        itable(x10_boolean (I::*_m0__at) (x10aux::ref<x10::lang::Object>), x10_boolean (I::*_m1__at) (x10::lang::Place), x10_boolean (I::*equals) (x10aux::ref<x10::lang::Any>), x10_int (I::*hashCode) (), x10::lang::Place (I::*home) (), FMGL(T) (I::*id) (), x10aux::ref<x10::lang::String> (I::*toString) (), x10aux::ref<x10::lang::String> (I::*typeName) ()) : _m0__at(_m0__at), _m1__at(_m1__at), equals(equals), hashCode(hashCode), home(home), id(id), toString(toString), typeName(typeName) {}
    ...
    static void _serialize(x10aux::ref<x10::compiler::Ref<FMGL(T)> > this_,
...
#include "x10/compiler/Ref.inc"


//#line 18 "/home/tux/workspace/x10.runtime/src-x10/x10/compiler/Ref.x10": x10.ast.PropertyDecl_c
