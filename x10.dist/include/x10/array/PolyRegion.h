...
class PolyRegion : public x10::array::Region   {
    ...
    virtual x10aux::ref<x10::array::Region__Scanner> scanner();
    ...
    static x10aux::ref<x10::lang::Object> FMGL(ROW__deserialize)(x10aux::deserialization_buffer &buf);
    ...
    static x10aux::ref<x10::lang::Object> FMGL(COL__deserialize)(x10aux::deserialization_buffer &buf);
    ...
    static x10aux::ref<x10::array::Region> makeBanded(x10_int size,
                                                      x10_int upper,
                                                      x10_int lower);
    static x10aux::ref<x10::array::Region> makeUpperTriangular2(
      x10_int rowMin,
      x10_int colMin,
      x10_int size);
    static x10aux::ref<x10::array::Region> makeLowerTriangular2(
      x10_int rowMin,
      x10_int colMin,
      x10_int size);
    ...
    virtual x10aux::ref<x10::lang::ValRail<x10_int > >
      min(
      );
    virtual x10aux::ref<x10::lang::ValRail<x10_int > >
      max(
...
template<class __T> x10aux::ref<__T> x10::array::PolyRegion::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::array::PolyRegion> this_ = new (x10aux::alloc_remote<x10::array::PolyRegion>()) x10::array::PolyRegion();
