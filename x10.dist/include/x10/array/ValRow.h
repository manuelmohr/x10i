...
class ValRow : public x10::array::Row   {
    ...
    x10aux::ref<x10::lang::ValRail<x10_int > > FMGL(row);
    
    void _constructor(x10aux::ref<x10::lang::ValRail<x10_int > > row);
    
    static x10aux::ref<x10::array::ValRow> _make(x10aux::ref<x10::lang::ValRail<x10_int > > row);
...
template<class __T> x10aux::ref<__T> x10::array::ValRow::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::array::ValRow> this_ = new (x10aux::alloc_remote<x10::array::ValRow>()) x10::array::ValRow();
