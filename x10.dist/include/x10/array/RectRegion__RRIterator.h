...
class RectRegion__RRIterator : public x10::lang::Object   {
    ...
    x10aux::ref<x10::lang::ValRail<x10_int > > FMGL(min);
    
    x10aux::ref<x10::lang::ValRail<x10_int > > FMGL(max);
...
template<class __T> x10aux::ref<__T> x10::array::RectRegion__RRIterator::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::array::RectRegion__RRIterator> this_ = new (x10aux::alloc_remote<x10::array::RectRegion__RRIterator>()) x10::array::RectRegion__RRIterator();
