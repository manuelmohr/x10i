...
class PolyMat : public x10::array::Mat<x10aux::ref<x10::array::PolyRow> >
  {
    ...
    virtual x10aux::ref<x10::lang::ValRail<x10_int > > rectMin(
      );
    virtual x10aux::ref<x10::lang::ValRail<x10_int > > rectMax(
      );
...
template<class __T> x10aux::ref<__T> x10::array::PolyMat::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::array::PolyMat> this_ = new (x10aux::alloc_remote<x10::array::PolyMat>()) x10::array::PolyMat();
