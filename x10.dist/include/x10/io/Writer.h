...
#ifndef X10_IO_WRITER_H_write_682
#define X10_IO_WRITER_H_write_682
template<class FMGL(T)> void x10::io::Writer::write(x10aux::ref<x10::io::Marshal<FMGL(T)> > m,
                                                    FMGL(T) x) {
    {
        
        //#line 45 "/home/tux/workspace/x10.runtime/src-x10/x10/io/Writer.x10": polyglot.ast.Eval_c
        (((x10::lang::Reference*)(((x10aux::ref<x10::lang::Reference>)x10aux::nullCheck(m)).operator->()))->*(x10aux::findITable<x10::io::Marshal<FMGL(T)> >(((x10aux::ref<x10::lang::Reference>)m)->_getITables())->write))(
          ((x10aux::ref<x10::io::Writer>)this),
          x);
        
        //#line 45 "/home/tux/workspace/x10.runtime/src-x10/x10/io/Writer.x10": x10.ast.X10Return_c
        return;
    }
}
#endif // X10_IO_WRITER_H_write_682
