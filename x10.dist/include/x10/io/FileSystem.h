...
class FileSystem : public x10::lang::Object   {
    ...
    static x10aux::ref<x10::lang::Object> FMGL(SEPARATOR_CHAR__deserialize)(x10aux::deserialization_buffer &buf);
    ...
    static x10aux::ref<x10::lang::Object> FMGL(SEPARATOR__deserialize)(x10aux::deserialization_buffer &buf);
    ...
    static x10aux::ref<x10::lang::Object> FMGL(PATH_SEPARATOR_CHAR__deserialize)(x10aux::deserialization_buffer &buf);
    ...
    static x10aux::ref<x10::lang::Object> FMGL(PATH_SEPARATOR__deserialize)(x10aux::deserialization_buffer &buf);
    static const x10aux::serialization_id_t FMGL(PATH_SEPARATOR__id);
    
    virtual void _kwd__delete(x10aux::ref<x10::io::File> id__61);
    virtual void deleteOnExit(x10aux::ref<x10::io::File> id__62);
    virtual void rename(x10aux::ref<x10::io::File> f, x10aux::ref<x10::io::File> t);
    virtual void mkdir(x10aux::ref<x10::io::File> id__63);
    virtual void mkdirs(x10aux::ref<x10::io::File> id__64);
    virtual x10_boolean exists(x10aux::ref<x10::io::File> id__65);
    virtual x10_long size(x10aux::ref<x10::io::File> id__66);
    virtual x10aux::ref<x10::lang::ValRail<x10aux::ref<x10::io::File> > >
      listFiles(
