...
class Marshal__IntMarshal : public x10::lang::Object   {
    public:
    RTT_H_DECLS_CLASS
    ...
    virtual x10_int read(x10aux::ref<x10::io::Reader> r);
    virtual void write(x10aux::ref<x10::io::Writer> w, x10_int i);
    void _constructor();
    
    static x10aux::ref<x10::io::Marshal__IntMarshal> _make();
...
template<class __T> x10aux::ref<__T> x10::io::Marshal__IntMarshal::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::io::Marshal__IntMarshal> this_ = new (x10aux::alloc_remote<x10::io::Marshal__IntMarshal>()) x10::io::Marshal__IntMarshal();
