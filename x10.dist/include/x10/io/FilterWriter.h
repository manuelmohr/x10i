...
class FilterWriter : public x10::io::Writer   {
    ...
    public: template<class FMGL(T1965)> void write(x10aux::ref<x10::io::Marshal<FMGL(T1965)> > p0, FMGL(T1965) p1);
...
template<class FMGL(T1965)> void x10::io::FilterWriter::write(x10aux::ref<x10::io::Marshal<FMGL(T1965)> > p0, FMGL(T1965) p1) {
    x10::io::Writer::write<FMGL(T1965)>(p0, p1);
}
template<class __T> x10aux::ref<__T> x10::io::FilterWriter::_deserializer(x10aux::deserialization_buffer& buf) {
    x10aux::ref<x10::io::FilterWriter> this_ = new (x10aux::alloc_remote<x10::io::FilterWriter>()) x10::io::FilterWriter();
