...
public struct IndexedMemoryChunk[T] {
    ...
    private native static def alloc_internal(numElements: long, sizeElement: int, alignment: int, congruent: Boolean, zeroed: Boolean) : Pointer;
    ...
    private static def alloc[T](numElements: long, sizeElements: int, alignment: int, congruent: Boolean, zeroed: Boolean) : IndexedMemoryChunk[T] {
        if(numElements <= 0) {
            return IndexedMemoryChunk[T](Pointer.NULL, Pointer.NULL, 0L);
        }
    ...
    private def this(alloc_p: Pointer, align_p : Pointer, l: long) {
        alloc_ptr = alloc_p;
        ptr = align_p;
        len = l;
    }
