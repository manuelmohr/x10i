...
x10_double _ZN3x104lang4Math3expEf(x10_float a) { return FUN(exp)(a); }
...
x10_double _ZN3x104lang4Math4sqrtEf(x10_float a) { return FUN(sqrt)(a); }
...
x10_double _ZN3x104lang4Math3logEf(x10_float a) { return FUN(log)(a); }
